...
public class ImageViewImp extends JFrame implements ImageViewInterface {
  ...
  public ImageViewImp(String caption, UIController controller) throws IOException {
    super(caption);
  ...
  public void setFeatures(Features feature) throws IOException {
    ...
    imageOpenChooser.addActionListener(
        l -> feature.loadImage(imageOpenChooser.getSelectedFile().getAbsolutePath()));

    imageSaveChooser.addActionListener(
        l -> feature.saveImage(imageSaveChooser.getSelectedFile().getAbsolutePath()));
    ...
    batchFileOpenChooser.addActionListener(
        l -> feature.executeBatchFile(batchFileOpenChooser.getSelectedFile().getAbsolutePath()));

    patternSaveOpenChooser.addActionListener(
        l -> feature.savePattern(patternSaveOpenChooser.getSelectedFile().getAbsolutePath()));
